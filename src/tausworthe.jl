...
"""
function tausworthe_rng(shape::Int=1; r::Int=3, q::Int=128)
    n_bits = 32
    shape *= n_bits
    seed = bitrand(q)
...
function tausworthe_rng(shape::Tuple{Vararg{Int}}; r::Int=3, q::Int=128)
    U = tausworthe_rng(reduce(*, shape), r=r, q=q)
